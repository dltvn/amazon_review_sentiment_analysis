...
save_plot(fig, "02_reviews_per_product_top20.png")
...
save_plot(fig, "03_reviews_per_product_hist.png")
...
save_plot(fig, "04_reviews_per_user_hist.png")
...
plt.suptitle("")
save_plot(fig, "05_review_length_by_rating.png")
...
ax.set_ylabel("Number of Reviews")
save_plot(fig, "06_review_length_hist.png")

# 7. Verified purchase by rating
if "verified" in df.columns:
    verified_rating = df.groupby(["overall", "verified"]).size().unstack(fill_value=0)
    fig, ax = plt.subplots(figsize=(8, 4))
    verified_rating.plot(kind="bar", ax=ax, edgecolor="white")
    ax.set_title("Verified vs Unverified Purchases by Rating")
    ax.set_xlabel("Rating")
    ax.set_ylabel("Number of Reviews")
    ax.set_xticklabels(ax.get_xticklabels(), rotation=0)
    save_plot(fig, "07_verified_by_rating.png")
...
ax.set_xticklabels(ax.get_xticklabels(), rotation=0)
save_plot(fig, "08_avg_length_by_rating.png")
